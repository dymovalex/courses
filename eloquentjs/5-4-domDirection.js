/*Напишите функцию, которая вычисляет доминирующее направление письма в строке текста. Помните,
что у каждого объекта шрифта есть свойство
direction, принимающее значения "ltr" (left to right, «слева направо»), "rtl"
